<header>
    ...
    <body>
         <form method="POST" class=leform>
            <label for="PatientID">Patient ID:</label><br>
            <input type="number" id="PatientID" name="PatientID" placeholder="Patient ID"> <br><br>
            <label for="PatientName">Patient Name:</label><br>
            <input type="text" id="PatientName" name="PatientName" placeholder="Patient Name"><br><br>
